            ...
            if (isset($_SESSION['utilisateur']['userID'])) {
                ...
                if ($data) {
                    ...
                    if ($data2) {
                        ...
                        $query5 = "INSERT INTO evaluations (touiteID, utilisateurID, evalue) VALUES (:touiteID, :utilisateurID, 0)";
                    ...
                    $query7 = "INSERT INTO touites (note) VALUES (0) WHERE touiteID = :touiteID";
